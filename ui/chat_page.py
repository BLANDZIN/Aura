...
class ChatPage(QWidget):
    ...
    def _build_ui(self):
        ...
        self._btn_voice.setCursor(Qt.CursorShape.PointingHandCursor)
        self._btn_voice.setCheckable(True)
        self._btn_voice.setFixedSize(48, 48)
        self._btn_voice.setToolTip("Ativar/desativar voz")
    ...
    def _toggle_voice(self):
        """Ativa/desativa fala automatica."""
        ...
        try:
            ...
            if self._voice_enabled:
                ...
                self._add_system_message("🔊 Voz ativada")
            else:
                voice_manager.stop()
                self._btn_voice.setText("🔇")
                self._add_system_message("🔇 Voz silenciada")
        except Exception as e:
            self._add_system_message(f"🔇 Voz indisponivel")
