...
def check_for_updates(
    ...
    # A tag do release (ex: v11.1.0) representa a versao do CORE da AURA.
    # Modulos com versionamento independente (angela 1.x, extensions 1.x)
    # serao sempre marcados como "precisa atualizar" porque a comparacao
    # eh feita contra a tag do release principal, nao contra versoes
    # especificas de cada modulo.
    # 
    # Isso NAO eh um bug — eh o comportamento esperado do sistema atual.
    # Para ter atualizacao per-modulo, seria necessario:
    #   a) Todas as versoes seguirem o mesmo ciclo (11.x), ou
    #   b) Um arquivo de manifesto no release com versoes por modulo
    # Ambas as opcoes exigem decisao arquitetural — nao foram implementadas.
    #
    # Compara cada módulo local com a versão do release
